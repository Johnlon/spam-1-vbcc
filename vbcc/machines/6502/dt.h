...
#define zf2zld(x) ((double)(x))
#define zd2zld(x) ((double)(x))
#define zld2zf(x) ((float)(x))
#define zld2zd(x) ((double)(x))
#define zld2zm(x) ((signed long)(x))
#define zm2zld(x) ((double)(x))
#define zld2zum(x) ((unsigned long)(x))
#define zum2zld(x) ((double)(x))
