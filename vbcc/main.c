...
//    fprintf(stdout, "=================================>>> gen_function <%s>,f=%p,real_gen=%d\n",v->identifier,(void*)f,real_gen);
...
//fprintf(stdout, "! 2 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 111\n");
        if(!input_wpo){
//fprintf(stdout, "! 4 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 111\n");
